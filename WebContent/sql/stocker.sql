...
insert into be_released values(seq_be_released.nextval, 1014, null, 'CG001', 150, '매장출고', to_date('2020-09-14', 'yyyy-mm-dd'));
insert into be_released values(seq_be_released.nextval, 1015, null, 'CT002', 100, '매장출고', to_date('2020-12-14', 'yyyy-mm-dd'));
...
--글번호 확인후 insert해야함..
--insert into board_comment values (seq_board_comment.nextval, 1, '전형돈', '넵! 꼭 참여하겠습니다 대표님!', 8, null, to_date('20200501', 'yyyymmdd'));
--insert into board_comment values (seq_board_comment.nextval, 1, '송은희', '제가 보관중입니다.', 9, null, to_date('20200514', 'yyyymmdd'));
--insert into board_comment values (seq_board_comment.nextval, 1, '방명수', '쯔위님 축하드려요~', 10, null, to_date('20200501', 'yyyymmdd'));
--insert into board_comment values (seq_board_comment.nextval, 1, '박나라', '축하드립니다~', 10, null, to_date('20200501', 'yyyymmdd'));
--insert into board_comment values (seq_board_comment.nextval, 1, '대북혼', '모두 즐거운 여름휴가 보내세요.', 11, null, to_date('20200615', 'yyyymmdd'));
--insert into board_comment values (seq_board_comment.nextval, 1, '하이유', '워크샵 기대됩니다 ㅎㅎ', 12, null, sysdate, 'yyyymmdd'));
--insert into board_comment values (seq_board_comment.nextval, 2, '방명수', '감사합니다. 연락드리겠습니다.', 9, 27, to_date('20200514', 'yyyymmdd'));
...
create or replace trigger trig_star_age
   after
   insert or update of star_rating on review
   for each row
begin
    update space 
    set star_avg = (
...
update space set like_cnt =0 where space_no='space2';
...
insert into wish values(
    'space2', 'sinsa@naver.com', sysdate
);

delete from wish where member_email='sinsa@naver.com';
